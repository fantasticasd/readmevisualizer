...
export interface ParagraphNode extends BaseContentNode {
    type: 'paragraph'
    /** Raw markdown text for this pargraph (used for word counting) */
    text: string
}
...
export interface DocumentSection {
    ...
    content: ContentNode[]
    /** 
     * True when this section was synthesises by the pipeline because the 
...
export interface DocumentMetadata {
 ...
 export interface DocumentStats {
    /** Wrd count from text modes only - code, links, metadata excluded */
    wordCount: number
...
export interface ParsedDocument {
    ...
    title: string
    /** Hierarichal section tree (only root-level sections here) */
